...
- "type": the specific claim type (see definitions below), or null (null only for framing claims)
...
No fact-checking is possible. These are value judgments, political opinions, or interpretive claims grounded in beliefs, sentiments, or personal values rather than objective facts.
- opinion: Example: "Smartphones should be banned for children under 16."
Important: a claim that attributes deliberate intent, hidden motives, or a strategic plan to a political actor is D/opinion, not C/causal. "The far right deliberately lets immigrants in to fuel hatred" is an interpretation of motives, not a verifiable causal mechanism. The underlying facts (visa numbers, policy changes) may be B, but the intentionality claim itself is D. Do not confuse verifiable facts with the interpretive narrative built on top of them.
...
- Do not classify an intentionality or motive claim as C/causal. If the claim attributes a deliberate strategy or hidden purpose to an actor, it is D/opinion.
